...
@section('header_title', 'نقطة البيع')
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ number_format($sale->price, 2) }} ر.س</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-emerald-600">{{ number_format($sale->total, 2) }} ر.س</td>
