...
@section('header_title', 'تعديل بيانات المورد')

@section('content')
<div class="max-w-xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="p-6 border-b border-gray-100 flex items-center justify-between">
            <h3 class="text-lg font-bold text-gray-700">تعديل: {{ $supplier->name }}</h3>
        ...
        <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST" class="p-8 space-y-6">
            ...
            <div class="pt-4 border-t border-gray-100 flex justify-end space-x-3 space-x-reverse">
                <a href="{{ route('suppliers.index') }}" class="px-6 py-3 text-gray-500 hover:text-gray-700 font-bold transition-colors">
                    إلغاء
                </a>
