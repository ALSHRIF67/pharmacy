...
<head>
    ...
    <title><?php echo e(config('app.name', 'Pharmacy ERP')); ?></title>
...
<body class="bg-gray-100 h-screen flex overflow-hidden">
    ...
    <div class="w-64 bg-slate-900 text-white flex-shrink-0 flex flex-col transition-all duration-300">
        ...
        <nav class="flex-1 mt-6 px-4 space-y-2 overflow-y-auto">
            <a href="<?php echo e(url('/')); ?>" class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(Request::is('/') ? 'bg-emerald-500 text-white' : 'hover:bg-slate-800 text-slate-300'); ?>">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(Request::is('products*') ? 'bg-emerald-500 text-white' : 'hover:bg-slate-800 text-slate-300'); ?>">
            ...
            <a href="<?php echo e(route('pos.index')); ?>" class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(Request::is('pos*') ? 'bg-emerald-500 text-white' : 'hover:bg-slate-800 text-slate-300'); ?>">
            ...
            <a href="<?php echo e(route('purchases.index')); ?>" class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(Request::is('purchases*') ? 'bg-emerald-500 text-white' : 'hover:bg-slate-800 text-slate-300'); ?>">
            ...
            <a href="<?php echo e(route('categories.index')); ?>" class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(Request::is('categories*') ? 'bg-emerald-500 text-white' : 'hover:bg-slate-800 text-slate-300'); ?>">
            ...
            <a href="<?php echo e(route('suppliers.index')); ?>" class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(Request::is('suppliers*') ? 'bg-emerald-500 text-white' : 'hover:bg-slate-800 text-slate-300'); ?>">
            ...
            <a href="<?php echo e(route('customers.index')); ?>" class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(Request::is('customers*') ? 'bg-emerald-500 text-white' : 'hover:bg-slate-800 text-slate-300'); ?>">
                <svg class="w-5 h-5 ml-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 005.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                <span>العملاء</span>
            </a>

            <a href="<?php echo e(route('reports.index')); ?>" class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(Request::is('reports*') ? 'bg-emerald-500 text-white' : 'hover:bg-slate-800 text-slate-300'); ?>">
                <svg class="w-5 h-5 ml-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                <span>التقارير</span>
            </a>

            <a href="<?php echo e(route('sync.index')); ?>" class="flex items-center px-4 py-3 rounded-lg transition-colors <?php echo e(Request::is('sync*') ? 'bg-emerald-500 text-white' : 'hover:bg-slate-800 text-slate-300'); ?>">
        ...
        <div class="p-4 bg-slate-800 text-slate-400 text-xs text-center">
            &copy; <?php echo e(date('Y')); ?> Pharmacy ERP
        </div>
    </div>
    ...
    <div class="flex-1 flex flex-col h-screen">
        ...
        <header class="bg-white shadow-sm h-16 flex items-center justify-between px-8 z-10">
            <h2 class="text-xl font-semibold text-gray-800">
                <?php echo $__env->yieldContent('header_title', 'لوحة القيادة'); ?>
            </h2>
            <div class="flex items-center space-y-2">
                <span class="text-sm text-gray-500 ml-4">أهلاً بك، <?php echo e(auth()->user()->name ?? 'مدير النظام'); ?></span>
...
<?php /**PATH C:\xamppp\htdocs\ph\resources\views/layouts/app.blade.php ENDPATH**/ ?>