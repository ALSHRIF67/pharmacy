<?php $__env->startSection('header_title', 'تفاصيل فاتورة الشراء'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-4xl mx-auto space-y-6">
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="p-6 border-b border-gray-100 flex justify-between items-center">
            <h3 class="text-lg font-bold text-gray-700">فاتورة #PUR-<?php echo e($purchase->id); ?></h3>
            <a href="<?php echo e(route('purchases.index')); ?>" class="text-sm text-gray-500 hover:text-emerald-500 flex items-center transition-colors">
        ...
        <div class="p-8 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="space-y-1">
                ...
                <div class="text-lg font-bold text-gray-800"><?php echo e($purchase->supplier->name); ?></div>
                <div class="text-sm text-gray-500"><?php echo e($purchase->supplier->phone); ?></div>
            </div>
            <div class="space-y-1">
                <div class="text-xs font-bold text-gray-400 uppercase tracking-wider">تاريخ الفاتورة</div>
                <div class="text-lg font-bold text-gray-800"><?php echo e($purchase->purchase_date->format('Y/m/d')); ?></div>
            </div>
            <div class="space-y-1">
                <div class="text-xs font-bold text-gray-400 uppercase tracking-wider">إجمالي المبلغ</div>
                <div class="text-2xl font-black text-emerald-600"><?php echo e(number_format($purchase->total_amount, 2)); ?> ر.س</div>
            </div>
        </div>
                    ...
                    <?php $__currentLoopData = $purchase->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-gray-600 font-mono">
                                <?php echo e($item->batch->batch_number); ?>

                                <span class="text-gray-400 text-xs">(انتهاء: <?php echo e($item->batch->expiry_date->format('Y/m')); ?>)</span>
                            </td>
                            <td class="px-6 py-4 text-center">
                                <span class="font-bold text-gray-700"><?php echo e($item->quantity); ?></span>
                            </td>
                            <td class="px-6 py-4 text-left text-gray-600">
                                <?php echo e(number_format($item->cost_price, 2)); ?>

                            </td>
                            <td class="px-6 py-4 text-left font-bold text-emerald-700">
                                <?php echo e(number_format($item->quantity * $item->cost_price, 2)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xamppp\htdocs\ph\resources\views/purchases/show.blade.php ENDPATH**/ ?>