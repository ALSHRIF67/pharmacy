<?php $__env->startSection('header_title', 'حالة مزامنة البيانات'); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="p-8 border-b border-gray-100 text-center">
            <div class="inline-flex items-center justify-center p-4 bg-emerald-50 rounded-full mb-4">
                <svg class="w-12 h-12 text-emerald-500 <?php echo e($totalPending > 0 ? 'animate-pulse' : ''); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path></svg>
            </div>
        ...
        <div class="p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-gray-50 p-6 rounded-xl border border-gray-100 text-center">
                ...
                <div class="text-2xl font-black <?php echo e($syncStats['products'] > 0 ? 'text-amber-500' : 'text-gray-400'); ?>">
                    <?php echo e($syncStats['products']); ?>

                </div>
            </div>
            <div class="bg-gray-50 p-6 rounded-xl border border-gray-100 text-center">
                <div class="text-xs font-bold text-gray-400 uppercase mb-1">التشغيلات</div>
                <div class="text-2xl font-black <?php echo e($syncStats['batches'] > 0 ? 'text-amber-500' : 'text-gray-400'); ?>">
                    <?php echo e($syncStats['batches']); ?>

                </div>
            </div>
            <div class="bg-gray-50 p-6 rounded-xl border border-gray-100 text-center">
                <div class="text-xs font-bold text-gray-400 uppercase mb-1">المبيعات</div>
                <div class="text-2xl font-black <?php echo e($syncStats['sales'] > 0 ? 'text-amber-500' : 'text-gray-400'); ?>">
                    <?php echo e($syncStats['sales']); ?>

                </div>
            </div>
            <div class="bg-gray-50 p-6 rounded-xl border border-gray-100 text-center">
                <div class="text-xs font-bold text-gray-400 uppercase mb-1">المشتريات</div>
                <div class="text-2xl font-black <?php echo e($syncStats['purchases'] > 0 ? 'text-amber-500' : 'text-gray-400'); ?>">
                    <?php echo e($syncStats['purchases']); ?>
        ...
        <div class="p-8 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
            <div class="flex items-center text-sm font-bold <?php echo e($totalPending > 0 ? 'text-amber-600' : 'text-emerald-600'); ?>">
                <?php if($totalPending > 0): ?>
                    ...
                    يوجد <?php echo e($totalPending); ?> سجل بانتظار المزامنة
                <?php else: ?>
            ...
            <?php if($totalPending > 0): ?>
                <form action="<?php echo e(route('sync.push')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xamppp\htdocs\ph\resources\views/sync/index.blade.php ENDPATH**/ ?>