...
<div class="max-w-2xl mx-auto bg-white rounded-xl shadow-sm overflow-hidden">
    ...
    <div class="p-8">
        <p class="text-sm text-gray-500 mb-6">لإضافة منتج جديد، يرجى الانتقال إلى صفحة <a href="<?php echo e(route('products.create')); ?>" class="text-emerald-500 hover:underline">إضافة منتج</a>.</p>
