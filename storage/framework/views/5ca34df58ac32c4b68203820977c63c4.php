<?php $__env->startSection('header_title', 'إضافة مورد جديد'); ?>
...
<div class="max-w-xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <form action="<?php echo e(route('suppliers.store')); ?>" method="POST" class="p-8 space-y-6">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xamppp\htdocs\ph\resources\views/suppliers/create.blade.php ENDPATH**/ ?>