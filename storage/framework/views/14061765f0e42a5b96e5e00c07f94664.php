...
<body class="bg-gray-100 font-sans antialiased">
    ...
    <!-- Scripts -->
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/offline/db.js', 'resources/js/pos/scanner.js']); ?>
    <script type="module">
...
<?php /**PATH C:\xamppp\htdocs\ph\resources\views/pos/index.blade.php ENDPATH**/ ?>